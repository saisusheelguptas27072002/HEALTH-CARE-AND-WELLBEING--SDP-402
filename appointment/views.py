...
def aboutus(request):
    return render(request, 'appointment/aboutus.html')


def wellness(request):
    return render(request, 'appointment/wellness.html')


def fitness(request):
    return render(request, 'appointment/fitness.html')
...
def show(request):
    ...
    return render(request, "appointment/show.html", {'employees': employees})


def edit(request, id):
    employee = Employee.objects.get(id=id)
    return render(request, 'appointment/edit.html', {'employee': employee})
